...
export type CardType = 'task_stats' | 'token_usage' | 'cost' | 'active_projects' | 'agent_status' | 'recent_tasks';
...
export const DEFAULT_LAYOUTS: ResponsiveLayouts = {
  lg: [
    ...
    { i: 'recent-tasks', x: 4, y: 8, w: 8, h: 3, minW: 3, minH: 2 },
  ],
  md: [
    ...
    { i: 'recent-tasks', x: 5, y: 8, w: 5, h: 3, minW: 3, minH: 2 },
  ],
  sm: [
    { i: 'task-stats', x: 0, y: 0, w: 6, h: 4, minW: 3, minH: 2 },
    ...
    { i: 'recent-tasks', x: 0, y: 19, w: 6, h: 3, minW: 3, minH: 2 },
  ],
};
